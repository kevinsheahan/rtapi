...
def test_InterfaceAddIpv4IP():
    assert rt.rtapi.InterfaceAddIpv4IP(obj_id, tobj.test_ip_interfaces[0], tobj.test_ip_addresses["ipv4"]) is None
...
def test_InterfaceAddIpv6IP():
    assert rt.rtapi.InterfaceAddIpv6IP(obj_id, tobj.test_ip_interfaces[0], tobj.test_ip_addresses["ipv6"]) is None


def test_DeleteObj():
    assert rt.rtapi.DeleteObject(obj_id) is None
